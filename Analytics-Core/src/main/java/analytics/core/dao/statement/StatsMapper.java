...
public interface StatsMapper {
	...
	String INCR_STAT_YEAR = "UPDATE stats SET accumulation = accumulation + :accumulation, gmt_modified = NOW() "
			+ YEAR_WHERE;
	...
	String INCR_STAT_MONTH = "UPDATE stats SET accumulation = accumulation + :accumulation, gmt_modified = NOW() "
			+ MONTH_WHERE;
	...
	String INCR_STAT_DAY = "UPDATE stats SET accumulation = accumulation + :accumulation, gmt_modified = NOW() "
			+ DAY_WHERE;
	...
	String INCR_STAT_HOUR = "UPDATE stats SET accumulation = accumulation + :accumulation, gmt_modified = NOW() "
			+ HOUR_WHERE;
}